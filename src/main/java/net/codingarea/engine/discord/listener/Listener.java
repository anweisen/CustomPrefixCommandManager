...
public interface Listener extends EventListener {
	...
	default void onEvent(@Nonnull GenericEvent event) {
		...
		List<Method> methods = getMethodsAnnotatedWith(this.getClass(), DiscordEvent.class);
	...
	static List<Method> getMethodsAnnotatedWith(Class<?> clazz, Class<? extends Annotation> annotation) {
	...
	static boolean paramIsOK(Class<?> expected, Class<?> given) {
