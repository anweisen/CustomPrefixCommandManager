 ...
 * on 08-30-2020
 *
 * This class allows you to easily load data from a file by a
 *
...
public class SecretsLoader {
	...
	public static SecretsLoader withoutException(String path, NamedValue... values) {
		try {
			return new SecretsLoader(path, values);
	...
	public static SecretsLoader withoutException(String path, String... values) {
		try {
			return new SecretsLoader(path, values);
		} catch (IOException ex) {
			ex.printStackTrace();
	...
	public SecretsLoader(String path, String... values) throws IOException {
		this(path, NamedValue.ofStrings(values));
	}

	public SecretsLoader(String path, NamedValue... values) throws IOException {
