...
public enum CommandType {
	 ...
	 * If this is not the case {@link CommandHandler#handleCommand(String, MessageReceivedEvent)} will return {@link CommandResult#INVALID_CHANNEL_PRIVATE_COMMAND}
	 */
	PRIVATE,

	/**
	 * Commands of this type can only be executed in a guild chat
	 * If this is not the case {@link CommandHandler#handleCommand(String, MessageReceivedEvent)} will return {@link CommandResult#INVALID_CHANNEL_GUILD_COMMAND}
	 */
	GUILD;
